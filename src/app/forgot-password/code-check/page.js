...
export default function CodeCheck() {
  ...
  const handleCodeCheck = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/reset-password-code-check`,
        data
      );
  ...
  const handleAgentCodeCheck = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/agent/reset-password-code-check`,
        data
      );
      setResponseMessage("Code Match Successfully");
      router.push("/forgot-password/password-reset");
  ...
  const handleSendCode = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/forgot-password`,
        {
          method: "POST",
          headers: {
  ...
  const handleAgentSendCode = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/agent/forgot-password`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
