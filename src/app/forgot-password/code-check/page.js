...
export default function CodeCheck() {
  ...
  const handleCodeCheck = async (event) => {
    ...
    try {
      const response = await axios.post(
        `http://api.mymakan.ae/auth/reset-password-code-check`,
        data
      );
  ...
  const handleAgentCodeCheck = async (event) => {
    ...
    try {
      const response = await axios.post(
        `http://api.mymakan.ae/auth/agent/reset-password-code-check`,
        data
      );
      setResponseMessage("Code Match Successfully");
      router.push("/forgot-password/password-reset");
  ...
  const handleSendCode = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://api.mymakan.ae/auth/forgot-password`,
        {
          method: "POST",
          headers: {
  ...
  const handleAgentSendCode = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://api.mymakan.ae/auth/agent/forgot-password`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
