...
const PostSearch = ({ open, user, setVerifyPopup, userName }) => {
  ...
  const PlaceholderIcon = () => (
    <div
      className="flex w-[55px] h-[55px] object-cover rounded-full shadow-md items-center justify-center bg-slate-100 motion-safe:animate-pulse dark:bg-slate-800"
      aria-hidden="true"
    >
      <svg
  ...
  return (
    <div className="bg-white mb-0 rounded-t-md grid grid-cols-11 items-center p-2 relative">
      ...
      <ul className="member-list col-span-9 flex justify-center items-center mx-2">
        <li className="w-full">
      ...
      <button
        className="col-span-1 flex justify-center !items-center hover:bg-[#dfdfdf6e] hover:rounded-full p-1"
        type="button"
