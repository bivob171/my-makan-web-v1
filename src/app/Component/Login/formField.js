  ...
  return (
    <>
        ...
        <>
          ...
          <div className="flex justify-center">
            <Link href="/forgot-password">
              <Button variant="link" className="text-sm my-3 text-[#2682d5]">
                Forgot Password?
              </Button>
            </Link>
          </div>
          <div>
            <Button
              ...
              className="w-[100%] border border-[#2682d5] bg-white hover:bg-[#1b6cb313] text-[#2682d5]"
            >
      ...
      <div className="flex items-center justify-center w-full my-4">
        ...
        <p className="px-3 w-fit text-gray-400 text-xs">OR SIGN IN USING</p>
        <hr className="w-[24%] text-gray-400" />
      </div>
