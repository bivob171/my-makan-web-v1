...
export default function PasswordChange() {
  ...
  const handlePasswordReset = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/reset-password`,
        data
      );
      console.log(response);
      if (response.status === 200) {
        setResetPasswordPopUp(true);
        setResponseMessage("Password Change Successfully");
      }
    } catch (error) {
      if (error.response) {
  ...
  const handleAgentPasswordReset = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://q2p08zg4-4000.asse.devtunnels.ms/auth/agent/reset-password`,
        data
      );
      if (response.status === 200) {
        setResetPasswordPopUp(true);
  ...
  return (
    <div className="bg-[#2682d5] h-screen 2xl:px-[350px] xl:px-60 xl:pb-[80px]    ">
      <div className="rounded-[15px] ">
        ...
        <div className="bg-white shadow-sm h-auto pb-[30px] rounded-[15px]">
