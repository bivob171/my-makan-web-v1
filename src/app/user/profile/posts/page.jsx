  ...
  return (
    <div className="page-content">
      <div className="container">
        <div>
          <div className="grid xl:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1 md:grid-cols-1 custom:grid-cols-2 gap-5">
            {data.map((item, i) => {
              return (
                <div
                  key={i}
                  className="w-[350px] h-auto  border-[0.1px] border-[#F5B849]  rounded-[15px] py-[25px] "
                >
                  <div>
                    ...
                    <div className="px-[15px] mt-[7px]">
                      <div>
                        ...
                        <p className="font-inter text-[#333335] text-[14px] font-normal  leading-[20px]">
                          Required Two Bedroom Hall open or Close kitchen For
                          Rent in City Tower, Ready to Move, for Family...
                    ...
                    <div className="px-[20px] flex items-center justify-between">
                      ...
                      <div>
                        <button className="bg-[#ebebeb] h-[25px] px-[13px] rounded flex items-center">
