    ...
    <div ref={dropdownRef}>
      <header className="fixed-header ">
        <div className="header-menu relative">
          <div className="navbar xl:h-[89px] lg:h-[89px] ">
            <div className="pb-[5px] nav-item d-none d-sm-block">
            ...
            <div className="relative nav-item header-control pb-[16px]">
              ...
              <div className=" inline-item d-flex align-items-center focus:outline-none">
                <div className="dropdown dropdown-friend border-none focus:outline-none">
                  <button
                    onClick={() => {
                ...
                <div className="dropdown dropdown-message focus:outline-none">
                  <button
                    onClick={() => {
                ...
                <div className="dropdown dropdown-notification focus:outline-none">
                  <button
                    className="dropdown-toggle focus:outline-none"
                    type="button"
                    onClick={() => {
              ...
              <div className="inline-item focus:outline-none">
                <div className="dropdown dropdown-admin focus:outline-none">
                  <button
                    className="dropdown-toggle focus:outline-none"
                    type="button"
                    data-toggle="dropdown"
                    aria-expanded="false"
                  >
                    <span className="media focus:outline-none">
                      <span
                        onClick={toggleMenu}
                        className="item-img focus:outline-none"
                      >
                      ...
                      <span
                        onClick={toggleMenu}
                        className="media-body -m-0 focus:outline-none"
                      >
                        <span className="item-title pb-[5px] focus:outline-none">
                          {userName}
                        </span>
                      </span>
                    </span>
